		...
		<div className="p-6 max-w-7xl mx-auto space-y-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
				<div className="bg-gradient-to-tr from-indigo-100 to-indigo-200 p-5 rounded-xl shadow text-center">
					...
					<p className="text-4xl font-bold text-indigo-900 mt-1">{totalTeachers}</p>
				</div>
				<div className="bg-gradient-to-tr from-green-100 to-green-200 p-5 rounded-xl shadow text-center">
					...
					<p className="text-4xl font-bold text-green-900 mt-1">{privateQualified}</p>
				</div>
				<div className="bg-gradient-to-tr from-yellow-100 to-yellow-200 p-5 rounded-xl shadow text-center">
					...
					<p className="text-4xl font-bold text-yellow-900 mt-1">{groupQualified}</p>
				</div>
				<div className="bg-gradient-to-tr from-pink-100 to-pink-200 p-5 rounded-xl shadow text-center">
					...
					<p className="text-4xl font-bold text-pink-900 mt-1">${avgPrivateRate}</p>
				</div>
			</div>

			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				<div className="bg-white p-6 rounded-lg shadow-lg border border-gray-100">
					<h2 className="text-lg font-semibold mb-4 text-indigo-800">📚 Qualifications Distribution</h2>
				...
				<div className="bg-white p-6 rounded-lg shadow-lg border border-gray-100">
					<h2 className="text-lg font-semibold mb-4 text-green-800">👥 Qualified Teachers Split</h2>
					<ResponsiveContainer width="100%" height={300}>
						<PieChart>
			...
			<div className="bg-white p-6 rounded-lg shadow-lg border border-gray-100">
				<h2 className="text-lg font-semibold mb-4 text-pink-800">📈 Avg Private Qualification Rate</h2>
				<ResponsiveContainer width="100%" height={300}>
